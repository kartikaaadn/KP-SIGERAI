        ...
        <div class="grid">
            ...
            <div class="card profile-card">
                ...
                <div class="profile-body">
                    <div class="profile-name">{{ $user->name ?? 'Admin MPP' }}</div>
                    ...
                    {{-- Edit Profile (hidden) --}}
                    <form class="edit-form" id="editForm" method="POST" action="{{ route('admin.profile.update') }}" style="display:none;">
                        @csrf

                        <div class="f-group">
                            <label class="f-label">Nama</label>
                            <input class="f-input" type="text" name="name" value="{{ old('name', $user->name) }}" required>
                        </div>
                        ...
                        <div class="f-group">
                            ...
                            <input class="f-input" type="email" name="email" value="{{ old('email', $user->email) }}" placeholder="optional">
                        </div>

                        <div class="f-group">
                            <label class="f-label">Kontak / No HP</label>
                            <input class="f-input" type="text" name="phone" value="{{ old('phone', $user->phone) }}" placeholder="optional">
                        </div>
            ...
            <div class="right-col">
                ...
                <div class="card">
                    ...
                    <div class="stats">
                        <div class="stat stat-green">
                            ...
                            <div class="stat-row">
                                <div class="stat-value">{{ $totalGeraiAktif ?? 0 }}</div>
                        ...
                        <div class="stat stat-red">
                            ...
                            <div class="stat-row">
                                <div class="stat-value">{{ $totalGeraiTidakAktif ?? 0 }}</div>
                        ...
                        <div class="stat stat-blue">
                            ...
                            <div class="stat-row">
                                <div class="stat-value">{{ $totalSeluruhLayanan ?? 0 }}</div>
                ...
                <div class="card">
                    ...
                    @if(($aktivitasTerbaru ?? collect())->count() == 0)
                        ...
                        <div class="activity-list">
                            @foreach($aktivitasTerbaru as $a)
                                <div class="activity-item">
                                    <div class="a-title">
                                        {{ $a->gerai->nama_gerai ?? 'Gerai' }}
                                    </div>
                                    <div class="a-sub">
                                        Input Layanan Harian • {{ $a->created_at?->format('d M Y, H:i') }}
                                    </div>
                                </div>
                            @endforeach
                        </div>
