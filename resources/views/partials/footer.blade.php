<footer class="sigera-footer">
    <div class="sigera-footer__wrap">
        {{-- KIRI: logo sejajar + teks di samping --}}
        <div class="sigera-footer__brand">
            <div class="sigera-footer__logos">
                <img src="{{ asset('assets/logo-dpmptsp.png') }}" alt="DPMPTSP" class="sigera-footer__logo">
                <img src="{{ asset('assets/logo-sigera.png') }}" alt="SIGERA" class="sigera-footer__logo">
            </div>
