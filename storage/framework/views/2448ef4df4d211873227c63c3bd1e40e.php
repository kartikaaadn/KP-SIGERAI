...
">
    ...
    <div style="display:flex; align-items:center; gap:10px; color:#fff;">
        <img src="<?php echo e(asset('assets/logo-dpmptsp.png')); ?>"
             alt="DPMPTSP"
             style="height:56px; object-fit:contain; margin-top:7px;">

        <img src="<?php echo e(asset('assets/logo-sigera.png')); ?>"
             alt="SIGERA"
    ...
    <?php if(auth()->guard()->check()): ?>
        ...
        <a href="<?php echo e($profileUrl); ?>" style="display:flex; align-items:center; gap:12px; color:#fff; text-decoration:none;">
            <?php if($avatar): ?>
            ...
            <div style="display:flex; flex-direction:column; line-height:1.1;">
                <div style="font-weight:800; font-size:14px;"><?php echo e($displayName); ?></div>
                <div style="font-size:12px; opacity:.9;"><?php echo e($displayRole); ?></div>
            </div>
        </a>
    <?php endif; ?>

</div>
<?php /**PATH C:\laragon\www\KP_SIGERAI\resources\views/partials/header.blade.php ENDPATH**/ ?>