    ...
    <style>
        ...
        body{
            background:
                ...
                url('<?php echo e(asset('assets/gedung.jpg')); ?>') center/cover no-repeat fixed;
        }
        ...
        <div class="content">
            ...
            <div class="stats">
                <div class="stat">
                    <div>👥</div>
                    <div>
                        <div class="num"><?php echo e($weeklyTotal); ?></div>
                ...
                <div class="stat">
                    <div>⬆️</div>
                    <div>
                        <div class="num"><?php echo e($max); ?></div>
                ...
                <div class="stat">
                    <div>↔️</div>
                    <div>
                        <div class="num"><?php echo e($median); ?></div>
                ...
                <div class="stat">
                    <div>⬇️</div>
                    <div>
                        <div class="num"><?php echo e($min); ?></div>
            ...
            <div class="bar">
                <form class="bar-left" method="GET">
                    ...
                    <input type="date" name="start" value="<?php echo e(request('start')); ?>">
                    <button class="btn btn-primary">Pilih</button>
                    <div class="rangeText"><?php echo e($rangeText); ?></div>
                </form>

                <div>
                    <a class="btn" href="<?php echo e(route('gerai.laporan.export', request()->query())); ?>">⬇ Ekspor</a>
                    <a class="btn btn-blue" href="<?php echo e(route('gerai.laporan.create', request()->query())); ?>">＋ Input Data Baru</a>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="totalBar">
                    Total Jumlah Pengguna Layanan Mingguan: <?php echo e($weeklyTotal); ?>
...
<?php /**PATH C:\laragon\www\KP_SIGERAI\resources\views/gerai/laporan/index.blade.php ENDPATH**/ ?>